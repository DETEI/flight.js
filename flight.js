...
/***/ function(module, exports, __webpack_require__) {
	...
	var textures = [{
	  file: '../../assets/flight.jpg',
	  name: 'image',
	  align: textureAlign,
	  scale: { x: 2, y: 2 }
	}, {
	  file: '../../assets/flight-mask.jpg',
	  name: 'mask',
	  align: textureAlign,
	  scale: { x: 0.05, y: 0.05 }
	}, {
	  file: '../../assets/flight-depth.jpg',
	  name: 'depth',
	  align: textureAlign,
	  scale: { x: 0.03, y: 0.05 }
	}, {
	...
	var contents = [loadContent('../../assets/air-travel-title.svg', document.querySelector('.Text-title')), loadContent('../../assets/air-travel-title-medium.svg', document.querySelector('.Text-titleMedium'), 0.5), loadContent('../../assets/air-travel-title-small.svg', document.querySelector('.Text-titleSmall'), 0.8)];
